...
public class MaiorConsumo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Passe a lista de consumo de dados semanais em MB separados por vírgula:");
        String input = scanner.nextLine();
        // Convertendo a entrada em uma lista de strings
        String[] consumoSemanal = input.split(",");
        System.out.println("Consumo de dados: " + Arrays.toString(consumoSemanal));
